  ...
  return (
    <div className={`opacity-0 animate-fadeInAnimate fill-mode-forward [&>input]:text-black`}>
        <PopUpModal isShow={isShow} isLoading={user?.isLoading} close={() => setIsShow(false)} maxWidth={800}>
            <h3 className='text-4xl font-medium mb-5 700res:text-2xl'>{`Описание пользователя ${user?.name}`}</h3>
        ...
        <div className='w-[1440px] mx-auto 1480res:w-full'>
            ...
            <div className={`my-10 1480res:px-5 flex gap-5 items-center justify-center [&_span]:flex [&_span]:gap-2 [&_span]:duration-300 [&_span]:btn-base
                ...
                <UserListBtn openedBlock={openedBlock} isLoading={isFavoriteLoading} setOpenedBlock={setOpenedBlock} num={1} title={"Любимые"}>
                ...
                <UserListBtn openedBlock={openedBlock} isLoading={isToWatchLoading} setOpenedBlock={setOpenedBlock} num={2} title={"Смотреть"}>
                ...
                <UserListBtn openedBlock={openedBlock} isLoading={isWatchedLoading} setOpenedBlock={setOpenedBlock} num={3} title={"Просмотрено"}>
                    <svg className='w-5 h-5' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
