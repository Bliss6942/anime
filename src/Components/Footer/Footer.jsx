    ...
    <div className='h-[90px] w-full mx-auto border-t-[1px] border-t-silver/30 mt-12 shrink-0' >
        <div className='h-full w-[1140px] px-5 mx-auto 1480res:w-full 1480res:px-5 flex justify-between items-center'>
            ...
            <div className='flex gap-5 items-center'>
                <a href="https://t.me/Kovinen" target='_blank' className='bg-def-black'>
                ...
                <a href="https://github.com/Bliss6942" target='_blank' className='bg-def-black'>
                    <svg className='w-[26px]' xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
                ...
                <a href="mailto:KomoriYantra@gmail.com" target='_blank' className='bg-def-black'>
                    <svg className='w-[26px]' xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
